    ...
    case Notification.WELCOME:
      ...
      body = `
        <div>
          ...
          <p>Stay tuned for more updates on ${product.title}.</p>
        </div>
      `;
      break;
...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "asmitv595@gmail.com",
    pass: process.env.EMAIL_PASSWORD, // Ensure this is defined in your .env.local
  },
});
